...
**★2026 03/26 変更点**  
・OSM本家のサーバーの規制が強化されたようで403エラーのポップアップが表示されるようになりました。そこでタイル取得の頻度を下げるとともにフランスのサーバーを使うように変更しました。
・将来フランス側のサーバーでも同様の規制がかかるかもしれません。その場合国土地理院のサーバーを使うように変更してください。そのためには192行目以降のL.tileLayer(の記述をコメントアウトして、212行以降の記述のコメントアウトを外してください。こうすると地図が国内だけになるのと雰囲気がだいぶ変わってしまいますが。
